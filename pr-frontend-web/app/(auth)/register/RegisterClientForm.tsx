...
export default function RegisterClientForm({ email, hasRegisterToken }: RegisterClientFormProps) {
      ...
      <div className="flex-1 flex justify-center flex-col items-center text-center">
        <form
          ...
          onSubmit={async (e) => {
            ...
            setLoading(true);
            try {
              const res = await registerUser({ email: email || "", username });
              // Ahora la server action devuelve { ok: true } o { ok: false, error }
